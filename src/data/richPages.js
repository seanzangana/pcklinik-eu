...
export function macHubHtml() {
  ...
  const faq = [
    { q: "Do you offer a loaner device while my Mac is being repaired?", a: "Loaner laptops are available to students when a repair will take more than a week, subject to availability and a refundable deposit. We don't offer loaners outside that." },
    ...
    { q: 'How much does Mac repair cost?', a: 'It depends on the fault and the model. We always diagnose first and give you a fixed quote before starting — standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours).' },
  ...
  <section class="section"><div class="wrap lead-copy"><div class="crumbs"><a href="/">Home</a> › <span>Mac Repair</span></div>
    <p>Whatever's wrong with your Mac — a MacBook, iMac, Mac mini, Mac Studio, or Mac Pro — we repair it. We diagnose the actual problem first, give you a fixed quote before starting, and get most repairs done fast. Standard diagnostics are 300 kr incl. VAT (2–4 days), or choose express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.</p></div></section>
  <section class="section alt"><div class="wrap"><div class="eyebrow">Our Promise</div><h2>Three simple steps</h2><div class="steps">
    <div class="step"><div class="num">1</div><h3>Book diagnostics</h3><p>300 kr incl. VAT (2–4 days) or express (600 kr incl. VAT, 1–2 hours).</p></div>
  ...
  <section class="section"><div class="wrap"><div class="cta-band"><h2>Ready to get your Mac looked at?</h2><p>Diagnostics 300 kr incl. VAT (2–4 days) or express for 600 kr incl. VAT (1–2 hours). Fixed quote before we start.</p><div class="cta-row"><a class="btn btn-white" href="/contact/">Book diagnostics</a><a class="btn btn-ghost-light" href="${site.phoneHref}">📞 Call ${site.phone}</a></div></div>
...
export function gamingHtml() {
  ...
  <section class="section"><div class="wrap lead-copy"><div class="crumbs"><a href="/">Home</a> › <span>Gaming PCs</span></div>
    ...
    <p><strong>For repairs and service:</strong> standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.</p>
  ...
  <section class="section alt"><div class="wrap"><div class="cta-band"><h2>Repair, upgrade, or build from scratch?</h2><p>Diagnostics are 300 kr incl. VAT (2–4 days) or express (600 kr incl. VAT). Custom builds are quote-based — no diagnostics fee.</p><div class="cta-row"><a class="btn btn-white" href="/contact/">Book diagnostics</a><a class="btn btn-ghost-light" href="${buildQuote}">Get a build quote</a></div></div>
...
export function errorMessagesHtml() {
  ...
  <section class="section"><div class="wrap"><div class="cta-band"><h2>Got one of these errors?</h2><p>We diagnose the root cause, not just the code. Diagnostics 300 kr incl. VAT (2–4 days) or express (600 kr incl. VAT, 1–2 hours), fixed quote before we start.</p><div class="cta-row"><a class="btn btn-white" href="/contact/">Book diagnostics</a><a class="btn btn-ghost-light" href="${site.phoneHref}">📞 Call ${site.phone}</a></div></div>
...
export function computerWontTurnOnHtml() {
  ...
  ${scen}
  <section class="section alt"><div class="wrap"><div class="eyebrow">Diagnostics &amp; pricing</div><h2>Standard or express — your choice</h2><p class="sub">Standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering. You get a fixed quote before we start.</p></div></section>
...
const FAQ_GROUPS = [
  ['General & Process', [
    ...
    ['How does diagnostics and repair work?', 'We diagnose the actual problem first, then give you a fixed quote before any repair work starts. Standard diagnostics are 300 kr incl. VAT (2–4 days), or choose express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.'],
    ['What if I need my device back faster than standard diagnostics?', 'Choose express diagnostics (600 kr incl. VAT, 1–2 hours) instead of the standard option (300 kr incl. VAT). Most express repairs are completed within 24 hours if no special parts need ordering.'],
  ...
  ['Services', [
    ...
    ['Do you repair liquid damage?', "Yes, for any brand or model. Liquid damage diagnostics work differently from our standard pricing — it's a flat 600 kr incl. VAT, takes 3–4 days, and there's no express option, since a proper assessment takes time. See <a href=\"/liquid-damage-repair/\">Liquid Damage Repair</a>."],
