...
export const locations = [
  {
    ...
    description: 'PC and Mac repair in Copenhagen for internationals, students, and businesses. No Danish required. Diagnostics from 300 kr incl. VAT, fixed quote.',
    ...
    intro: [
      ...
      "We're based in Frederiksberg, a short trip from most of central Copenhagen by metro or bike, and we serve the whole city plus the rest of Denmark via remote support. Standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.",
    ],
    faq: [
  ...
  },
  {
    ...
    description: 'PC and Mac repair in Frederiksberg, walking distance from Copenhagen Business School (CBS). English-speaking, diagnostics from 300 kr incl. VAT.',
    ...
    intro: [
      ...
      "We work with CBS students, international staff, and Frederiksberg residents in English, no Danish needed. Standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering, which matters when you're on a deadline.",
    ],
    ...
    faq: [
      ...
      { q: 'Can you help if I need my laptop back before an exam?', a: "Tell us the timeline — express diagnostics (600 kr incl. VAT, 1–2 hours) is your fastest option, and we'll be upfront about whether we can meet your deadline." },
  ...
  },
  {
    ...
    description: 'PC and Mac repair for Vesterbro residents — popular with CBS students and internationals. English-speaking, diagnostics from 300 kr incl. VAT.',
  ...
  },
  {
    ...
    description: 'PC and Mac repair for Vanløse residents. English-speaking service, diagnostics from 300 kr incl. VAT, fixed quote before any work starts.',
    h1: 'Computer Repair in Vanløse', subhead: 'English-speaking repair, a short trip from Vanløse',
    intro: ['We serve Vanløse residents from our Frederiksberg workshop, entirely in English — no Danish required. Standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.'],
    faq: [
  ...
  },
  {
    ...
    description: 'PC and Mac repair for Valby residents. English-speaking service, diagnostics from 300 kr incl. VAT, fixed quote before any work starts.',
    h1: 'Computer Repair in Valby', subhead: 'English-speaking repair, a short trip from Valby',
    intro: ['We serve Valby residents from our Frederiksberg workshop, entirely in English — no Danish required. Standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.'],
    faq: [
  ...
  },
  {
    ...
    description: 'PC and Mac repair for Nordvest (NV) Copenhagen residents. English-speaking service, diagnostics from 300 kr incl. VAT, fixed quote.',
    h1: 'Computer Repair in Nordvest (NV Copenhagen)', subhead: 'English-speaking repair, a short trip from NV',
    intro: ['We serve Nordvest (NV) residents from our Frederiksberg workshop, entirely in English — no Danish required. Standard diagnostics are 300 kr incl. VAT (2–4 days), or express for 600 kr incl. VAT (1–2 hours) — with repair and delivery within 24 hours if no special parts need ordering.'],
    faq: [
